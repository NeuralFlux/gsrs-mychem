    ...
    mapping = {
        "gsrs": {
            "properties": {
                ...
                "definitiontype": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "definitionlevel": {
                    "normalizer": "keyword_lowercase_normalizer",
                    "type": "keyword",
                },
                "substanceclass": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "status": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "version": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "approvedby": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "names": {
                    "properties": {
                        "uuid": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                        "type": {"type": "text"},
                ...
                "approvalid": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "structurallydiverse": {
                    "properties": {
                        "uuid": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                        "part": {"type": "text"},
                ...
                "structure": {
                    "properties": {
                        ...
                        "charge": {"type": "integer"},
                        "mwt": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                        "count": {"type": "float"},
                        "references": {
                            "normalizer": "keyword_lowercase_normalizer",
                            "type": "keyword",
                        },
                        "hash": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},

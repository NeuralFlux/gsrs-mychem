...
graph_mychem.add_edge(
    "smiles",
    "pubchem",
    object=MongoDBEdge("pubchem", "pubchem.smiles", "pubchem.cid"),
    weight=1.2,
)
...
graph_mychem.add_edge(
    ...
    "inchikey",
    #   TODO drugbank_full
    object=MongoDBEdge("drugbank_full", "drugbank.products.ndc_product_code", "drugbank.inchi_key"),
)
...
# Unii Edges
###############################################################################
graph_mychem.add_edge("unii", "inchikey", object=MongoDBEdge("unii", "unii.unii", "unii.inchikey"))
graph_mychem.add_edge("unii", "pubchem", object=MongoDBEdge("unii", "unii.unii", "unii.pubchem"))
